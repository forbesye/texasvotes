...
class DistrictSchema(BaseSchema):
    ...
    elected_officials = fields.Nested('PoliticianSchema', only=("id", "name", "party", "image", "current"), required=True, attribute="politicians", many=True)
    elections = fields.Nested('ElectionSchema', only=("id", "office"), required=True, many=True)
